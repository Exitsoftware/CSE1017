...
# 		board.append([])
# 		for j in range(10):
# 			if(j >= 1 and j <= 8 and i >= 1 and i <= 8):
# 				if((i + j) % 2 == 0):
# 					board[i].append("□")
# 				else:
# 					board[i].append("■")
...
def search_pone():
	...
	return random.choice(position) #탐
